...
<sch:schema xmlns:voc="http://www.lantanagroup.com/voc" xmlns:svs="urn:ihe:iti:svs:2008" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:cda="urn:hl7-org:v3" xmlns:sdtc="urn:hl7-org:sdtc" xmlns="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.3.61-errors">
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.24.3.61-errors" context="cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.24.3.61']">
      ...
      <sch:assert id="a-11376" test="cda:templateId[@root='2.16.840.1.113883.10.20.24.3.61']">This templateId SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.24.3.61" (CONF:11376).</sch:assert>
    </sch:rule>
  </sch:pattern>
...
SHALL contain exactly one [1..1] effectiveTime (CONF:14445).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.3.27-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.24.3.27-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-12815" test="count(cda:templateId[@root='2.16.840.1.113883.10.20.24.3.27'])=1">SHALL contain exactly one [1..1] templateId (CONF:12815) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.24.3.27" (CONF:12816).</sch:assert>
...
SHALL contain exactly one [1..1] custodian (CONF:16600).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.3.36-errors">
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.24.3.36-errors" context="cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.24.3.36']">
      ...
      <sch:assert id="a-13964" test="cda:templateId[@root='2.16.840.1.113883.10.20.24.3.36']">This templateId SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.24.3.36" (CONF:13964).</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.3.35-errors">
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.24.3.35-errors" context="cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.24.3.35']">
      ...
      <sch:assert id="a-14063" test="cda:templateId[@root='2.16.840.1.113883.10.20.24.3.35']">This templateId SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.24.3.35" (CONF:14063).</sch:assert>
    </sch:rule>
  </sch:pattern>
